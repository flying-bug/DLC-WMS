...
public class AssemblyOrderController {
    ...
    public ApiResponse<Void> generateInventoryDocument(
            @PathVariable Long id,
            @Valid @RequestBody com.duylongtech.backend.feature.inventory.GenerateInventoryDocumentRequest request,
            HttpServletRequest servletRequest) {
        String ip = getClientIp(servletRequest);
        String actor = getCurrentUser();
        try {
    ...
    public ApiResponse<Void> executeAssemblyOrder(
            @PathVariable Long id,
            @RequestBody @Valid com.duylongtech.backend.feature.assembly.AssemblyExecutionRequest request,
            HttpServletRequest servletRequest) {
        String ip = getClientIp(servletRequest);
        String actor = getCurrentUser();
