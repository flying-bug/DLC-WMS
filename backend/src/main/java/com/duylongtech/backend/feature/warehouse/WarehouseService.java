...
import com.duylongtech.backend.feature.warehouse.WarehouseMapper;
...
public class WarehouseService {
    ...
    private final com.duylongtech.backend.feature.product.SerialNumberRepository serialNumberRepository;
    private final com.duylongtech.backend.feature.assembly.DeviceComponentSerialRepository deviceComponentSerialRepository;
    ...
    public Page<WarehouseResponse> getWarehouses(String search, String status, Pageable pageable) {
        ...
        return page.map(warehouseMapper::toResponse);
    }
    ...
    @Transactional(readOnly = true)
    public List<com.duylongtech.backend.feature.warehouse.WarehouseStockAiRow> getWarehouseInventory(Long warehouseId) {
