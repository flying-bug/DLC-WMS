...
public class AuthService {
    ...
    public AuthService(AuthenticationManager authenticationManager, JwtUtils jwtUtils, com.duylongtech.backend.feature.auth.UserRepository userRepository, org.springframework.security.crypto.password.PasswordEncoder passwordEncoder, EmailService emailService, RealtimeSessionService realtimeSessionService) {
