...
import com.duylongtech.backend.feature.partner.CustomerService;
...
public class CustomerController {
    ...
    public org.springframework.http.ResponseEntity<byte[]> exportCustomers(
        ...
        java.util.List<com.duylongtech.backend.feature.partner.Partner> customers = customerService.getCustomersForExport(ids, keyword, status, groupType);
    ...
    public ApiResponse<com.duylongtech.backend.feature.partner.CustomerResponse.ImportPreviewResponse> previewImport(
    ...
    public ApiResponse<Void> confirmImport(
            @RequestBody com.duylongtech.backend.feature.partner.CustomerRequest.ImportConfirmRequest request
    ) {
