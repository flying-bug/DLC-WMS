...
public class ImportDocumentController {
    ...
    public ApiResponse<List<com.duylongtech.backend.feature.audit.AuditLogResponse>> getImportLogs(@PathVariable Long id) {
        org.springframework.data.domain.Page<com.duylongtech.backend.feature.audit.AuditLog> page = auditLogService.getLogsForEntity("ImportSlip", id, 0, 100);
