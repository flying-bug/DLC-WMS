...
public class EmailService {
    ...
    @Async
    public void sendSalesOrderQuoteEmail(String toEmail, com.duylongtech.backend.feature.sales_order.SalesOrderResponse so, String customMessage) {
        if (toEmail == null || toEmail.trim().isEmpty()) {
        ...
        if (so.getLines() != null) {
            int stt = 1;
            for (com.duylongtech.backend.feature.sales_order.SalesOrderResponse.SalesOrderLineResponse line : so.getLines()) {
