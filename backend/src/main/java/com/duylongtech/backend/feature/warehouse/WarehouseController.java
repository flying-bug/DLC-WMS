...
public class WarehouseController {
    ...
    @GetMapping("/{id}/logs")
    @PreAuthorize("hasAuthority('warehouse_master:view') or hasRole('MANAGER')")
    public ResponseEntity<ApiResponse<Page<com.duylongtech.backend.feature.audit.AuditLog>>> getWarehouseLogs(
    ...
    @PreAuthorize("hasAuthority('warehouse_master:view') or hasRole('MANAGER')")
    public ResponseEntity<ApiResponse<List<com.duylongtech.backend.feature.report.SerialTreeResponse>>> getSerialTree(@PathVariable Long id, @PathVariable Long variantId) {
