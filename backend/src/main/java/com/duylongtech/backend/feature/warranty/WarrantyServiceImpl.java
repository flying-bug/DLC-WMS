...
import com.duylongtech.backend.feature.warranty.WarrantyMapper;
import com.duylongtech.backend.feature.warranty.WarrantyRepository;
import com.duylongtech.backend.feature.warranty.WarrantyResponse;
...
public class WarrantyServiceImpl  implements WarrantyService {
    ...
    private final com.duylongtech.backend.feature.warranty.WarrantyMapper warrantyMapper;
    ...
    private WarrantyResponse toResponse(Warranty warranty, boolean includeRepairs) {
        ...
        if (warranty.getLines() != null && !warranty.getLines().isEmpty()) {
            List<com.duylongtech.backend.feature.warranty.WarrantyLineResponse> lineResponses = warranty.getLines().stream().map(line -> {
                com.duylongtech.backend.feature.warranty.WarrantyLineResponse lineResp = warrantyMapper.toLineResponse(line);
