...
public class AuthServiceImpl  implements AuthService {
    ...
    public AuthServiceImpl(AuthenticationManager authenticationManager, JwtUtils jwtUtils, com.duylongtech.backend.feature.auth.UserRepository userRepository, org.springframework.security.crypto.password.PasswordEncoder passwordEncoder, EmailService emailService, RealtimeSessionService realtimeSessionService) {
    ...
    public void changePassword(ChangePasswordRequest request) {
        ...
        com.duylongtech.backend.feature.auth.User user = userRepository.findByUsername(currentUsername)
                .orElseThrow(() -> new BusinessException(SystemMessage.USER_NOT_FOUND));
