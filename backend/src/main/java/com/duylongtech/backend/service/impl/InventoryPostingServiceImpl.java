...
public class InventoryPostingServiceImpl implements com.duylongtech.backend.service.InventoryPostingService {
    ...
    public boolean isAssemblyDocument(com.duylongtech.backend.entity.InventoryDocument doc) {
        if (doc == null) {
            return false;
        }
