...
public class AuthServiceImpl  implements AuthService {
    ...
    public AuthServiceImpl(AuthenticationManager authenticationManager, JwtUtils jwtUtils, com.duylongtech.backend.repository.UserRepository userRepository, org.springframework.security.crypto.password.PasswordEncoder passwordEncoder, EmailService emailService, RealtimeSessionService realtimeSessionService) {
